...
func main() {
	...
	parser.String("push", "", "push to remote sqlite managed by re, requires --host or .configW:re.remote.host")
	parser.String("pull", "", "pull from remote sqlite managed by re, requires --host or .configW:re.remote.host")
